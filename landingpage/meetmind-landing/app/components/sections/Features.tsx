...
const features = [
  {
    ...
    description: (
      <>
        Our proprietary model identifies <span className="font-bold text-zinc-900 dark:text-white  tracking-tighter">Intent</span>, <span className="font-bold text-zinc-900 dark:text-white  tracking-tighter">Deadlines</span>, and <span className="font-bold text-zinc-900 dark:text-white  tracking-tighter">Owners</span> from messy transcripts with surgical accuracy.
      </>
    ),
...
export default function Features() {
  return (
    <section id="features" className="py-24 px-6 bg-white dark:bg-zinc-950 transition-colors duration-500">
